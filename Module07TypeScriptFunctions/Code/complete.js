/*
 * Module 07 - TypeScript Functions
 * Topics:
...
console.log("****************************************************************");
function functionDeclaration2(param1, param2) {
    return param1 + param2;
}
...
let functionExpression1 = function (param1, param2) {
    return param1 + param2;
};
...
let functionExpression2 = function (param1, param2) {
    return param1 + param2;
};
...
function functionDeclaration3(param1, param2) {
    return param1 + param2;
}
...
function optionalParameterFunction1(param1, param2) {
    return param1 + param2;
}
...
function defaultParameterFunction1(param1, param2 = 0) {
    return param1 + param2;
}
...
console.log("****************************************************************");
// Rest syntax
function restFunction1(...operands) {
...
console.log("****************************************************************");
function callBackCallerFunction1(callBackFunction) {
...
function callBackCallerFunction2(callBackFunction) {
    let someData = " maybe";
...
console.log("****************************************************************");
function voidFunction1(param1, param2) {
...
console.log("****************************************************************");
function neverFunction1(param1, param2) {
...
function functionOverloads1(param1, param2) {
    return param1 + param2;
}
