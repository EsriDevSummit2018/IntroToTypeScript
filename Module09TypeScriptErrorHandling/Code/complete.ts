/*
 * Module 09 - TypeScript Error Handling
 * Topics: 
 *      Creating Error Interfaces and Classes
 *      throw, try, catch, finally in TypeScript
 */
console.log("Module 09 - TypeScript Error Handling complete.js loaded...");
...
class ExceptionHandling {
    ...
    tryCatchFinally() {
        ...
        finally { console.log("exceptionHandling.tryCatchFinally() finished.")}
    }
    tryFinally() {
        try {
            throw new Error("Exception in try block.");
        }
        finally { console.log("exceptionHandling.tryFinally() finished.")}        
    }
}
...
class AJAXExecption {
    ...
    constructor(public name: string, public message: string, 
                ...
                public innerException?: ExceptionInterface) {
        this.stack = (new Error(message)).stack;
    }  
}

let exception: ExceptionInterface = { name: "Exception", message: "Exception" };
//throw exception;
// throw new AJAXExecption("AJAXException", "AJAX Exception", 
//                         "http://localhost:8080/api/data");
// throw new AJAXExecption("AJAXException", "AJAX Exception", 
//                         "http://localhost:8080/api/data", exception);
}