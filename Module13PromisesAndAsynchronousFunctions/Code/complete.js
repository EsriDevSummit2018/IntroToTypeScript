...
/*
 * Module 13 - Promises and Asynchronous Functions
 * Topics:
 *      Using Promises
 *      Promise States
 *      Promise Methods
 ...
 */
console.log("Module 13 - Promises and Asynchronous Functions complete.js loaded...");
var Complete;
(function (Complete) {
    console.log("");
    console.log("****************************************************************");
    ...
    function asyncCallReturnPromiseLongSyntax(calledFrom) {
        ...
        let promise = new Promise(pretendAsyncFunction);
        return promise;
    }
