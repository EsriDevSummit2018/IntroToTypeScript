/*
 * Module 04 - TypeScript Variables and Scope
 * Topics:
 *      TypeScript Comments
...
console.log("****************************************************************");
let letBoolean;
let letBooleanTrue = true;
let letBooleanFalse = false;
let letNumber;
let letNumber0 = 0;
let letNumber5 = 5;
let letString;
let letStringEmpty = "";
let letStringHello = "Hello";
let letStringFalse = "False";
...
console.log("****************************************************************");
let assertAny1 = "string";
let assertString1 = assertAny1;
let assertString2 = assertAny1;
