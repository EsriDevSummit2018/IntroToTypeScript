...
(function (Complete) {
    ...
    console.log("****************************************************************");
    ;
    var name11 = { lastName: "Flintstone", firstName: "Fred" };
    ...
    var name12 = { firstName: "Barney", lastName: "Rubble", age: 25 }; // Fixed with a type assertion
    ...
    var name17 = { firstName: "Barney", lastName: "Rubble", age: 25 }; // Fixed with a type assertion
    displayName("name17", name17);
    console.log("");
    console.log("****************************************************************");
    console.log("Topic - Optional Properties");
    console.log("****************************************************************");
    ; // Optional Property, like optional parameters
    var name18 = { firstName: "Barney", lastName: "Rubble" };
    displayName("name18", name18);
    var name19 = { firstName: "Barney", lastName: "Rubble", age: 25 };
    ...
    console.log("****************************************************************");
    ; // Readonly Property
    var name20 = { firstName: "Barney", lastName: "Rubble", age: 25, id: 123 };
